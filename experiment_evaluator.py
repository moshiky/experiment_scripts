...
class ExperimentEvaluator:
    ...
    def generate_results(self, path_list_file_path=None):
        ...
        if path_list_file_path is None:
            # read id list
            ...
            self.__logger.log('evaluation folders from path list file')
            with open(path_list_file_path, 'rb') as path_list_file:
                folder_paths_to_evaluate = path_list_file.read().replace('\r', '').split('\n')
    ...
    def __parse_selected_lines(self, log_lines):
        ...
        for line in log_lines:
            ...
            elif line.find('ex_eval_mean:') > 0:  # evaluation log line
                if not in_eval:
                    time_part = line.split(' >> ')[0]
                    curr_time = datetime.strptime(time_part, time_format)
    ...
    def generate_users_score(self):
        ...
        for uid in user_ids:
            ...
            for experiment_type in exp_list:
                ...
                meta_info[uid][experiment_type]['train_time'] = raw_info_dict[uid][experiment_type]['train_time']
                meta_info[uid][experiment_type]['eval_time'] = raw_info_dict[uid][experiment_type]['eval_time']
        ...
        stats_keys = ['train_mean', 'train_time', 'eval_mean', 'eval_time']
